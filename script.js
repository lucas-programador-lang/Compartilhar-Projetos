/* =========================================================
   COMPARTILHAR PROJETOS — SCRIPT.JS (v20 - Código Completo e Corrigido)
   ========================================================= */
...
(function () {
  ...
  // Variáveis Globais (chatListenerUnsubscribe no topo)
  let db = null;
  ...
  function initSupportChatWidget(user) {
      ...
      widget.innerHTML = `
          <style>
            ...
            /* CSS DAS BOLHAS DE CHAT INJETADAS AQUI */
      ...
      endBtnUser.addEventListener("click", async () => {
          const ok = await confirmActionUser("Sair da conversa de suporte? O chat será encerrado definitivamente.", { title: "Sair do Chat", confirmLabel: "Sim, sair", neutral: true });
          if (!ok) return;
