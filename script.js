/* =========================================================
   COMPARTILHAR PROJETOS — SCRIPT.JS (v14 - Chat e Sincronia Completa)
  ...
  function initSupportChatWidget(user) {
      ...
      widget.innerHTML = `
          ...
          <button class="support-bubble-btn" id="openChatBtn">
              <!-- Ícone de chat duplo mais moderno -->
    ...
    overlay.innerHTML = `
      <div style="position: relative !important; width: 100% !important; max-width: 380px !important; background: #131b2b !important; border-radius: 22px !important; padding: 32px 24px !important; text-align: center !important; box-shadow: 0 20px 40px rgba(0,0,0,0.5) !important; box-sizing: border-box !important; margin: auto !important; color: #f8fafc !important;">
        ...
        <div style="display:flex; justify-content:center; gap:16px; margin-bottom:28px;">
            <a href="https://api.whatsapp.com/send?text=${encWa}" target="_blank" aria-label="WhatsApp" style="width:48px; height:48px; border-radius:50%; background:#25D366; color:#fff; display:flex; align-items:center; justify-content:center; text-decoration:none;">
            ...
            <a href="https://www.facebook.com/sharer/sharer.php?u=${encUrl}" target="_blank" aria-label="Facebook" style="width:48px; height:48px; border-radius:50%; background:#1877F2; color:#fff; display:flex; align-items:center; justify-content:center; text-decoration:none;">
                <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            <a href="https://twitter.com/intent/tweet?text=${encText}&url=${encUrl}" target="_blank" aria-label="X (Twitter)" style="width:48px; height:48px; border-radius:50%; background:#000000; color:#fff; display:flex; align-items:center; justify-content:center; text-decoration:none;">
            ...
            <a href="https://www.linkedin.com/shareArticle?mini=true&url=${encUrl}&title=${encodeURIComponent(titulo)}" target="_blank" aria-label="LinkedIn" style="width:48px; height:48px; border-radius:50%; background:#0A66C2; color:#fff; display:flex; align-items:center; justify-content:center; text-decoration:none;">
